    ...
    def train(rng: chex.PRNGKey) -> Tuple[CPOState, dict]:
        ...
        def _update_step(
            ...
            def _env_step(
                ...
                cpo_state, env_state, obs, running_cost, cost_discount, rng = (
                    runner_state
                )
            ...
            cpo_state, env_state, last_obs, running_cost, cost_discount, rng = (
                runner_state
            )
        ...
        # RUN TRAINING LOOP
        rng, _rng = jax.random.split(rng)
        runner_state = (cpo_state, env_state, obsv, running_cost, cost_discount, _rng)
